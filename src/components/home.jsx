...
const Home = () => {
    return (
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            {/*Animation image */}
            <div className={`flx-1 ${styles.flexStart} md:my-0 my-10`}>
                <img src={robot} alt="robot" className="w-[500px] h-[500px] relative z-10 rounded-lg" />
            </div>
            {/*Information */}
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
                ...
                <p className={`${styles.paragraph} mt-5 max-w-[550px]`}>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, repudiandae impedit deleniti facilis possimus ratione unde natus odio ducimus praesentium?
                </p>

                {/*Getting started */}
                <Button styles={'mt-2 text-white'} />

                {/*Gradient Background */}
                <div className="absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient"></div>
                <div className="absolute z-[1] w-[55%] h-[80%] rounded-full bottom-40 white__gradient"></div>
